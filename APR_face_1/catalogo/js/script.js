...
function agregarProductoAlCarrito(productoData, personalizado = false) {
    ...
    // Usamos el ID real del producto que viene de data-producto
    const producto = {
        id: productoData.id, 
        ...
        tipo_producto: 'catalogo', // Marcamos que es un producto del catálogo
        fecha_agregado: new Date().toISOString() // Opcional: para seguimiento
    };
